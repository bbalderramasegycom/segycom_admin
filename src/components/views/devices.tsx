...
function createData(
    ...
    return {id, nombre, marca, cantidad, registro};
  }
  
  const rows = [
    createData(1, 'FM3612', 'Teltonika', 2, '2019-03-15 13:14:19'),
    createData(2, 'FM3612', 'Teltonika', 2, '2019-03-15 13:14:19'),
    createData(3, 'FM3612', 'Teltonika', 2, '2019-03-15 13:14:19'),
    createData(4, 'FM3612', 'Teltonika', 2, '2019-03-15 13:14:19'),
                ...
                <Paper elevation={3} sx={styles.padTable}>
                    <Grid container item xs={12} >
                        <Grid xs={6} sx={styles.marTable}>  
                            <Typography variant="h6">Tabla con datos de Dispositivos</Typography>  
                        </Grid>
                    ...
                    <Grid container item xs={12} sx={styles.tablestyles} justifyItems='center' >   
                        ...
                        <Table  aria-label="simple table">
                            ...
                            <TableRow>
                                ...
                                <TableCell align="right">Cantidad De Dispositivos</TableCell>
